...
| Field | Value |
| --- | --- |
| **Name** | `github-automation-tips-skill` |
...
cp -r github/github-automation-tips ~/.hermes/skills/github/github-automation-tips/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/github-automation-tips-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/github-automation-tips-skill.git ~/.hermes/skills/github/github-automation-tips/
```
...
```text
skill_view(name="github/github-automation-tips")
```
...
```text
Use the github automation tips skill to <describe your specific task here>
```
...
```text
Gunakan skill github automation tips untuk <deskripsikan tugas spesifik Anda di sini>
```
